...
function first_formula_test($atts, $content){
    $processUrl =   plugins_url('cpf_formula/includes/cpf_controbution_process.php');
?> 
    <form class="form-horizontal" role="form" id="cpf_cal_form">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    <div class="col-md-8">
                        <label for="usr">CPF Donation Type:</label>
                        <select class="form-control" name="CPFDT" id="CPFDT">
...
<?php }
 ...
 add_shortcode('formula_1', 'first_formula_test');